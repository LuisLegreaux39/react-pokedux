...
export const getAllPokemons = (limit = 10) => service.getRequest({ path: `pokemon?limit=?limit=${limit}&offset=200` });
...
export const getTypes = async () => await service.getRequest<GenericWrapper<Type[]>>({ path: `type` });
